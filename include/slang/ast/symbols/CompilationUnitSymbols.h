...
private:
    // sukimasim: parameterized packages (IEEE 1800-2023 §26.2) build their
    // specializations here, so they need access to the export state.
    friend class GenericPackageDefSymbol;
