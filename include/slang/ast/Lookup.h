...
enum class SLANG_EXPORT LookupFlags {
    ...
    /// This lookup is for an identifier generated by token pasting.
    /// Issue warnings instead of errors for undeclared identifiers.
    TokenPastingContext = 1 << 16,
...
SLANG_BITMASK(LookupFlags, TokenPastingContext)
