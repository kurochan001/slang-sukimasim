...
> **2026-09-04 更新**: この一覧は歴史記録。現行の基準は **67 件** で、
> [session-2026-09-04-fork-bugfixes.md](session-2026-09-04-fork-bugfixes.md) に
> 一覧・突き合わせ手順・差分の由来がある。失敗件数が動いたら (改善でも) 同じコミットで
> 基準リストと CLAUDE.md の件数を更新すること。
