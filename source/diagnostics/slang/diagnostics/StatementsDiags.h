...
inline constexpr DiagCode SoftConstraintNoRand(DiagSubsystem::Statements, 71);
inline constexpr DiagCode SolveBeforeCircular(DiagSubsystem::Statements, 72);
inline constexpr DiagCode SolveBeforeRepeated(DiagSubsystem::Statements, 73);
inline constexpr DiagCode StatementNotInLoop(DiagSubsystem::Statements, 74);
inline constexpr DiagCode SubroutineMatchAutoRefArg(DiagSubsystem::Statements, 75);
inline constexpr DiagCode SubroutineMatchNonVoid(DiagSubsystem::Statements, 76);
inline constexpr DiagCode SubroutineMatchOutArg(DiagSubsystem::Statements, 77);
inline constexpr DiagCode TaskInConstraint(DiagSubsystem::Statements, 78);
inline constexpr DiagCode ThroughoutLhsInvalid(DiagSubsystem::Statements, 79);
inline constexpr DiagCode TimingInFuncNotAllowed(DiagSubsystem::Statements, 80);
inline constexpr DiagCode TooManyForeachVars(DiagSubsystem::Statements, 81);
inline constexpr DiagCode UnexpectedPortDecl(DiagSubsystem::Statements, 82);
inline constexpr DiagCode UnknownConstraintLiteral(DiagSubsystem::Statements, 83);
inline constexpr DiagCode VoidCastFuncCall(DiagSubsystem::Statements, 84);
inline constexpr DiagCode WriteToInputClockVar(DiagSubsystem::Statements, 85);
inline constexpr DiagCode NoteAlwaysFalse(DiagSubsystem::Statements, 86);
inline constexpr DiagCode NoteWhileExpanding(DiagSubsystem::Statements, 87);
inline constexpr DiagCode BadProceduralForce(DiagSubsystem::Statements, 88);
inline constexpr DiagCode CaseDefault(DiagSubsystem::Statements, 89);
inline constexpr DiagCode CaseRedundantDefault(DiagSubsystem::Statements, 90);
inline constexpr DiagCode CaseWildcard2State(DiagSubsystem::Statements, 91);
inline constexpr DiagCode EmptyStatement(DiagSubsystem::Statements, 92);
inline constexpr DiagCode EventExpressionConstant(DiagSubsystem::Statements, 93);
inline constexpr DiagCode MultiBitEdge(DiagSubsystem::Statements, 94);
inline constexpr DiagCode PointlessVoidCast(DiagSubsystem::Statements, 95);
inline constexpr DiagCode SeqNoMatch(DiagSubsystem::Statements, 96);
inline constexpr DiagCode UnusedResult(DiagSubsystem::Statements, 97);
inline constexpr DiagCode VacuousCover(DiagSubsystem::Statements, 98);
