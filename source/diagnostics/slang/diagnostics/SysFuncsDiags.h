...
inline constexpr DiagCode QueryOnAssociativeNonIntegral(DiagSubsystem::SysFuncs, 30);
inline constexpr DiagCode QueryOnAssociativeWildcard(DiagSubsystem::SysFuncs, 31);
inline constexpr DiagCode QueryOnDynamicType(DiagSubsystem::SysFuncs, 32);
inline constexpr DiagCode SampledValueLocalVar(DiagSubsystem::SysFuncs, 33);
inline constexpr DiagCode SampledValueMatched(DiagSubsystem::SysFuncs, 34);
inline constexpr DiagCode SeqMethodInputLocalVar(DiagSubsystem::SysFuncs, 35);
inline constexpr DiagCode SequenceMatchedOutsideAssertion(DiagSubsystem::SysFuncs, 36);
