...
inline constexpr DiagCode ValueOutOfRange(DiagSubsystem::Numeric, 8);
inline constexpr DiagCode RealLiteralOverflow(DiagSubsystem::Numeric, 9);
inline constexpr DiagCode RealLiteralUnderflow(DiagSubsystem::Numeric, 10);
inline constexpr DiagCode SignedIntegerOverflow(DiagSubsystem::Numeric, 11);
inline constexpr DiagCode ValueMustBePositive(DiagSubsystem::Numeric, 12);
inline constexpr DiagCode ValueMustNotBeUnknown(DiagSubsystem::Numeric, 13);
