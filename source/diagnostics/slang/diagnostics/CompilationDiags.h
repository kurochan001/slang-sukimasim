...
inline constexpr DiagCode MultipleDefaultClocking(DiagSubsystem::Compilation, 20);
inline constexpr DiagCode MultipleDefaultDisable(DiagSubsystem::Compilation, 21);
inline constexpr DiagCode MultipleGlobalClocking(DiagSubsystem::Compilation, 22);
inline constexpr DiagCode MultipleNetAlias(DiagSubsystem::Compilation, 23);
inline constexpr DiagCode MultipleTopDupName(DiagSubsystem::Compilation, 24);
inline constexpr DiagCode NestedConfigMultipleTops(DiagSubsystem::Compilation, 25);
inline constexpr DiagCode NetAliasSelf(DiagSubsystem::Compilation, 26);
inline constexpr DiagCode NoDeclInClass(DiagSubsystem::Compilation, 27);
inline constexpr DiagCode TopModuleIfacePort(DiagSubsystem::Compilation, 28);
inline constexpr DiagCode TopModuleRefPort(DiagSubsystem::Compilation, 29);
inline constexpr DiagCode TopModuleUnnamedRefPort(DiagSubsystem::Compilation, 30);
inline constexpr DiagCode UnknownLibrary(DiagSubsystem::Compilation, 31);
inline constexpr DiagCode VirtualIfaceHierRef(DiagSubsystem::Compilation, 32);
inline constexpr DiagCode VirtualIfaceIfacePort(DiagSubsystem::Compilation, 33);
inline constexpr DiagCode WrongBindTargetDef(DiagSubsystem::Compilation, 34);
inline constexpr DiagCode InfinitelyRecursiveHierarchy(DiagSubsystem::Compilation, 35);
inline constexpr DiagCode MaxInstanceDepthExceeded(DiagSubsystem::Compilation, 36);
inline constexpr DiagCode NoteAliasDeclaration(DiagSubsystem::Compilation, 37);
inline constexpr DiagCode NoteAliasedTo(DiagSubsystem::Compilation, 38);
inline constexpr DiagCode NoteHierarchicalRef(DiagSubsystem::Compilation, 39);
inline constexpr DiagCode DuplicateDefparam(DiagSubsystem::Compilation, 40);
inline constexpr DiagCode MissingTimeScale(DiagSubsystem::Compilation, 41);
